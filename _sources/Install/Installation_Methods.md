...
Welcome to the installation section of the FEniCSx and GMSH Tutorials.

This page provides an overview and links to the specific installation guides tailored for different environments, including High-Performance Computing (HPC) clusters like MCIA and CASSIOPEE, and local setups using WSL and Docker.

Please select the guide that best matches your target environment.

---

## 1. HPC Cluster Installations (Spack)

These guides are tailored for installing the FEniCSx stack using **Spack**, primarily on HPC environments.

### Spack Installation (MCIA)
...
## 2. Local Machine Installations (WSL & Docker)

These guides are for setting up the environment on personal workstations running Windows Subsystem for Linux (WSL) or Docker.
